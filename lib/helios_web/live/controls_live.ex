defmodule HeliosWeb.ControlsLive do
      ...
      <div class="flex ml-12 mt-2">
          ...
          <div class="w-9/12">
              <form phx-change="slider">
                <div class=""><input name="slider1" value={"#{@slider1}"} id="default-range" type="range"  class="w-10/12 h-3  rounded appearance-none cursor-pointer bg-yellow-200"></div>
                <div class=""><input name="slider2" value={"#{@slider2}"} id="default-range" type="range"  class="w-10/12 h-3  rounded-lg appearance-none cursor-pointer bg-gray-100"></div>
                <div class=""><input name="slider3" value={"#{@slider3}"} id="default-range" type="range"  class="w-10/12 h-3  rounded-lg appearance-none cursor-pointer bg-blue-200"></div>
              </form>
          </div>
      ...
      <div class="flex pl-7">
          <div class="flex flex-col w-8/12 ">
              <div class="flex items-center">
                  <div class="flex items-center">
                      <select name="sent_name" class="hselect font-['heliosfont']"  id="" >
  ...
  <div class="">
      ...
      <div class="flex items-center justify-evenly ">
          ...
          <form phx-change="fan">
              <label class=" relative inline-flex items-center mr-5 cursor-pointer">
                  <input type="checkbox" name="fan" class="sr-only peer" >
                  <div class="w-11 h-6 bg-gray-200 rounded-full peer dark:bg-gray-700 peer-focus:ring-4 peer-focus:ring-green-300 dark:peer-focus:ring-green-800 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-green-600"></div>
                  <!-- <span class="ml-3 text-sm font-medium text-gray-900 dark:text-gray-300">Green</span> -->
                </label>
          </form>
  ...
  <div class="">
      ...
      <div class="flex items-center  justify-start">
          ...
          <form phx-change="wifi">
              <label class="  relative inline-flex items-center mr-5 cursor-pointer">
                  <input name="wifi" type="checkbox" class="sr-only peer" checked>
                  <div class="w-11 h-6 bg-gray-200 rounded-full peer dark:bg-gray-700 peer-focus:ring-4 peer-focus:ring-green-300 dark:peer-focus:ring-green-800 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-green-600"></div>
                  <!-- <span class="ml-3 text-sm font-medium text-gray-900 dark:text-gray-300">Green</span> -->
                </label>
          </form>
